...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React23.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React23.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React23.useMemo(() => storageManager?.({
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PA5K4HBC.js.map
